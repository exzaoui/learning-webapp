...
angular.module('webapp.blog', ['ngRoute', 'firebase'])
...
.controller('BlogCtrl', ['$scope', 'CommonProp', '$firebaseArray', '$firebaseObject', '$location', function($scope, CommonProp, $firebaseArray, $firebaseObject, $location){
